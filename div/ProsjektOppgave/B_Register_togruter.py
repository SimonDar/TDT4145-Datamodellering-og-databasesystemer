...
for Togrute in range (1,4):
    ...
    for dagIndeks in range (0,len(row)):
        ...
        for DelstrekningIndeks in range(0, len(delstrekningArray[Togrute-1])):
            ...
            IDstrekning += 1
            skalidatabase = "INSERT INTO Strekning VALUES({}, {}, {}, {}, {}, {}, {});".format((IDstrekning), Togrute, avgang, annkomst, FirstStrekning , delstrekningArray[Togrute-1][DelstrekningIndeks], TotalPlasserArray[Togrute-1])
            print(skalidatabase)
